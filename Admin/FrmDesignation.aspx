<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="FrmDesignation.aspx.cs" Inherits="Admin_FrmDesignation" %>
    ...
    <div class="card shadow-none border my-4" data-component-card="data-component-card">
        <div class="card-header p-4 border-bottom bg-body">
            <div class="row g-3 justify-content-between align-items-center">
                <div class="col-12 col-md">
                    <h4 class="text-body mb-0">Designaion Manager</h4>
                    ...
                    <nav class="nav justify-content-end doc-tab-nav align-items-center" role="tablist">
                        <a id="aenter" class="btn btn-sm btn-phoenix-primary code-btn ms-2 collapsed" style="width: 10.4375rem !important;" data-bs-toggle="collapse" href="#example-code" role="button" aria-controls="example-code" aria-expanded="false">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16px" height="16px" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-code me-2">
                                <polyline points="16 18 22 12 16 6"></polyline><polyline points="8 6 2 12 8 18"></polyline></svg>Add Designation</a><a style="width: 10.4375rem !important;" class="btn btn-sm btn-phoenix-primary preview-btn ms-2"><svg xmlns="http://www.w3.org/2000/svg" width="16px" height="16px" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-eye me-2"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path><circle cx="12" cy="12" r="3"></circle></svg>Add Designation</a>
                    </nav>
                </div>
            </div>
        </div>
        <div class="card-body p-0">
            <div class="code-collapse collapse" id="example-code" style="padding: 1%;">
                <div class="col-md-6">
                    <label class="form-label" for="basic-url">
                        <strong>Add Designation :</strong><asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ErrorMessage="Add Designation" ControlToValidate="txtdesignation" Font-Size="Small" ForeColor="Red" ValidationGroup="AA"></asp:RequiredFieldValidator>
                    </label>
            ...
            <div class="p-4 code-to-copy">
                <div class="table-responsive scrollbar">
                    <asp:GridView ID="gvDesignation" runat="server" AutoGenerateColumns="False" DataKeyNames="Id_pk" CCellSpacing="0" CssClass="table fs-9 mb-0"  OnRowCommand="gvDesignation_RowCommand">
                        <Columns>
                            <asp:BoundField DataField="Id_pk" HeaderText="ID" />
                            <asp:BoundField DataField="Designation" HeaderText="Designation" />
                            <asp:TemplateField HeaderText="Actions">
                                <ItemTemplate>
                                    <a
                                        onclick="return funPopSetup1('<%#Eval("Id_pk")%>','<%#Eval("Designation") %>');">
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                if ($('#ContentPlaceHolder1_gvDesignation tbody tr').length > 0) {
                    var table1 = $('#ContentPlaceHolder1_gvDesignation').DataTable({
            ...
            function funPopSetup1(adata,adata1) {
                ...
                document.getElementById("<%=txtdesignation.ClientID%>").value = adata1;
